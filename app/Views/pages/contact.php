...
<head>
    ...
    <title><?= e($title ?? 'Contact | DJ Wilgen Rivas') ?></title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="contact-card shadow-lg">
                    <h4 class="mb-4 text-primary text-uppercase">Direct Booking Channels</h4>

                    <a href="https://web.facebook.com/wilgen.rivas.16" target="_blank" rel="noreferrer" class="social-link fb">
                        <i class="fab fa-facebook-f"></i> Facebook / Wilgen Rivas
                    </a>

                    <a href="https://t.me/the_dj" target="_blank" rel="noreferrer" class="social-link tg">
